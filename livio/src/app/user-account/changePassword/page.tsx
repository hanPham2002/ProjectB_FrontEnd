...
import {Button, Col, DatePicker, Form, FormProps, Input, Layout, Row, Select} from 'antd';
...
const Page = () => {
    ...
    return (
        <div style={{width:'100%', marginLeft:'140px' }}>
            <Form
                form={form}
                name="profile"
                layout="vertical"
            ...
            >
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: 30, marginTop: 20 , marginLeft:400,  }}>
                    <Button
